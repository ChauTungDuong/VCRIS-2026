      ...
      vi: {
        ...
        content: makePuckContent([
          ai4crisSection({
            ...
            titleAlign: "center",
            variant: "plain",
            contentHtml: "<p class=\\"text-[20px] text-slate italic text-center\\" style=\\"font-family: var(--font-body)\\">Thông tin về Diễn giả của Hội thảo AI4CRIS sẽ được cập nhật trong thời gian tới!</p>"
          })
        ])
      }
    },
      ...
      vi: {
        ...
        content: makePuckContent([
          ...
          ai4crisSection({
            ...
            titleAlign: "left",
            variant: "card-white",
            contentHtml: "<p><strong>Email:</strong> <a href=\\"mailto:AI4CRIS@actvn.edu.vn\\" class=\\"text-cipher hover:underline\\">AI4CRIS@actvn.edu.vn</a></p><p><strong>Website:</strong> <a href=\\"https://ai4cris.actvn.edu.vn\\" target=\\"_blank\\" class=\\"text-cipher hover:underline\\">https://ai4cris.actvn.edu.vn</a></p><p class=\\"mt-4\\">Ban Tổ chức trân trọng kính mời các nhà khoa học, chuyên gia, doanh nghiệp và cơ quan quản lý tham gia gửi bài và đồng hành cùng Hội thảo AI4CRIS 2026.</p>"
          }),
          ai4crisSection({
            title: "Lưu ý:",
            titleAlign: "left",
