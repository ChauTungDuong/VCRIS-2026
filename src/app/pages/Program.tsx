                      ...
                      <tr className="hover:bg-paper/50 transition-colors">
                        ...
                        <td className="p-4 align-top">
                          <div className="flex flex-col gap-1">
                            ...
                            <p><i>Thiếu tướng, PGS. TS. Nguyễn Ngọc Cương</i></p>
                              ...
                              <div className="overflow-x-auto rounded-lg border border-rule">
                                <table className="w-full text-left border-collapse text-[15px]">
                                  ...
                                  <tbody className="divide-y divide-rule bg-white">
                                    <tr>
                                      <td className="p-3 align-top">Phạm Hương Trà</td>
                                    ...
                                    <tr>
                                      <td className="p-3 align-top">Đàm Thế Vinh</td>
                                    ...
                                    <tr>
                                      ...
                                      <td className="p-3 align-top">Học viện Báo chí và Tuyên truyền</td>
                                      <td className="p-3 align-top">ỨNG DỤNG TRÍ TUỆ NHÂN TẠO TRONG PHÒNG, CHỐNG THÔNG TIN GIẢ TRÊN MÔI TRƯỜNG SỐ: THỰC TRẠNG VÀ GIẢI PHÁP</td>
                                    </tr>
                                    <tr>
                                      <td className="p-3 align-top">Trần Thọ Xương</td>
                                    ...
                                    <tr>
                                      <td className="p-3 align-top">Trần Thị Phương Lan</td>
                              ...
                              <div className="overflow-x-auto rounded-lg border border-rule">
                                <table className="w-full text-left border-collapse text-[15px]">
                                  ...
                                  <tbody className="divide-y divide-rule bg-white">
                                    ...
                                    <tr>
                                      <td className="p-3 align-top">Nguyễn Như Chiến</td>
                              ...
                              <div className="overflow-x-auto rounded-lg border border-rule">
                                <table className="w-full text-left border-collapse text-[15px]">
                                  ...
                                  <tbody className="divide-y divide-rule bg-white">
                                    ...
                                    <tr>
                                      <td className="p-3 align-top">Cao Hong Lam</td>
                                    ...
                                    <tr>
                                      <td className="p-3 align-top">Vũ Xuân Trường</td>
                                      <td className="p-3 align-top">Học viện Kỹ thuật và Công nghệ an ninh</td>
                            ...
                            <td className="p-4">
                              ...
                              <div className="overflow-x-auto rounded-lg border border-rule">
                                <table className="w-full text-left border-collapse text-[15px]">
                                  ...
                                  <tbody className="divide-y divide-rule bg-white">
                                    <tr>
                                      <td className="p-3 align-top">Phạm Ngọc Minh</td>
                                    ...
                                    <tr>
                                      <td className="p-3 align-top">Nguyễn Đăng Bắc</td>
                                    ...
                                    <tr>
                                      <td className="p-3 align-top">Trương Xuân Hùng</td>
                                      <td className="p-3 align-top">Học viện Kỹ thuật mật mã</td>
                                    ...
                                    <tr>
                                      <td className="p-3 align-top">Hoàng Nhật Anh</td>
                            ...
                            <td className="p-4">
                              ...
                              <div className="overflow-x-auto rounded-lg border border-rule">
                                <table className="w-full text-left border-collapse text-[15px]">
                                  ...
                                  <tbody className="divide-y divide-rule bg-white">
                                    <tr>
                                      <td className="p-3 align-top">Nguyễn Thị Thu Hương</td>
                                    ...
                                    <tr>
                                      <td className="p-3 align-top">Lê Thị Yến Như</td>
                                    ...
                                    <tr>
                                      <td className="p-3 align-top">Thân Văn Thanh</td>
                                      <td className="p-3 align-top">Học viện Báo chí và Tuyên truyền</td>
                                    ...
                                    <tr>
                                      ...
                                      <td className="p-3 align-top">Quản trị dữ liệu cá nhân trong kỷ nguyên trí tuệ nhân tạo Thách thức và giải pháp bảo đảm an toàn thông tin</td>
                                    </tr>
                                    <tr>
                                      <td className="p-3 align-top">Đặng Huyền Linh</td>
                                      <td className="p-3 align-top">Học viện Báo chí và Tuyên truyền</td>
